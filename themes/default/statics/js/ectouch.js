...
/*相册控制*/
if(typeof(document.getElementById('img-photo-box'))==Object){
	let img_photo_box = document.getElementById('img-photo-box');
	img_photo_box.style.width = document.body.offsetWidth + 'px';
	img_photo_box.style.height = document.body.offsetWidth + 'px';     	
