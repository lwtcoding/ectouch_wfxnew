...
<div class="order_status">
	<div class="flex-row_detail border_line">
		<div class="flex-title">
			<?php echo $this->_var['lang']['order_status']; ?>
		</div>
		<div class="flex-content">
			<span><?php echo $this->_var['order']['order_status']; ?> <?php echo $this->_var['order']['pay_status']; ?> <?php echo $this->_var['order']['shipping_status']; ?></span>
		</div>
	</div>
</div>
<section class="user-order-detail" style="border-top:none;padding: 0;border-bottom: 0;">
	<div class="flex-row_detail border_line">
			<div class="flex-title">
				<?php echo $this->_var['lang']['order_number']; ?>
			</div>
			<div class="flex-content">
				<span><?php echo $this->_var['order']['order_sn']; ?></span>
			</div>
	</div>
	<div class="flex-row_detail border_line">
			<div class="flex-title">
				<?php echo $this->_var['lang']['order_money']; ?>
			</div>
			<div class="flex-content">
				<span><?php echo $this->_var['order']['formated_total_fee']; ?></span>
			</div>
	</div>
	<div class="flex-row_detail border_line">
			<div class="flex-title">
				<?php echo $this->_var['lang']['order_addtime']; ?>
			</div>
			<div class="flex-content">
				<span><?php echo $this->_var['order']['formated_add_time']; ?></span>
			</div>
	</div>
	<?php if ($this->_var['order']['invoice_no']): ?>
	<div class="flex-row_detail border_line">
			<div class="flex-title">
				<?php echo $this->_var['lang']['consignment']; ?>
			</div>
			<div class="flex-content">
				<span><?php echo $this->_var['order']['invoice_no']; ?></span>
			</div>
	</div>
	<?php endif; ?>
	...
	<div class="flex-row_detail border_line">
				<div class="flex-title">
					<?php echo $this->_var['lang']['detail_to_buyer']; ?>
				</div>
				<div class="flex-content">
					<span><?php echo $this->_var['order']['to_buyer']; ?></span>
				</div>
	</div>
	<?php endif; ?>
...
?>
      <li>
      	<a class="flex-row border_line" style="padding: 1rem 0;margin-bottom: 1rem;" href="<?php echo url('goods/index', array('id'=>$this->_var['goods']['goods_id']));?>" target="_blank">
      		<img src="<?php echo $this->_var['goods']['goods_thumb']; ?>">
      		<div class="order_info_text">
          	<h4 class="title"><?php echo $this->_var['goods']['goods_name']; ?></h4>
          	<p><?php echo $this->_var['goods']['goods_attr']; ?></p>
      		</div>
      	</a>
      	<div class="dd-price"><?php echo $this->_var['lang']['number_to']; ?>：<?php echo $this->_var['goods']['goods_number']; ?></div>
      	<div class="dd-price"><?php echo $this->_var['lang']['ws_subtotal']; ?>：<span class="ect-colory"><?php echo $this->_var['goods']['subtotal']; ?></span></div>
        <div class="flex-row order_am_btn" style="margin-top: 1rem;">
            <?php if ($this->_var['goods']['aftermarket'] == 1): ?>
	              <a class="flex-item text_center" href="<?php echo url('user/aftermarket_done',array('rec_id'=>$this->_var['goods']['rec_id'],'order_id'=>$this->_var['order']['order_id']));?>" >查看申请记录</a>
	              <a class="flex-item text_center" href="<?php echo url('user/aftermarket_detail',array('ret_id'=>$this->_var['goods']['ret_id']));?>" >退换货详情</a>
	          <?php else: ?>
		          <?php if ($this->_var['goods']['service_apply']): ?>
		            <a class="flex-item text_center" href="<?php echo url('user/aftermarket',array('rec_id'=>$this->_var['goods']['rec_id'],'order_id'=>$this->_var['order']['order_id']));?>" >申请售后</a>
		          <?php endif; ?>
	          <?php endif; ?>
        </div>
      </li>
...
<section class="order-detail-info ect-margin-tb" style="margin-bottom:0;padding: 0;">
	<div class="flex-row_detail border_line">
				<div class="flex-title">
					<?php echo $this->_var['lang']['consignee_name']; ?>
				</div>
				<div class="flex-content">
	...
	<div class="flex-row_detail border_line">
				...
				<div class="flex-content">
					<span><?php echo $this->_var['order']['mobile']; ?></span>
				</div>
	</div>
  ...
  <div class="flex-row_detail border_line">
		...
		<div class="flex-content">
			<span><?php echo $this->_var['order']['address']; ?></span>
		</div>
	</div>
	<?php endif; ?> 
	<div class="flex-row_detail border_line">
		...
		<div class="flex-content">
			<p><?php echo $this->_var['lang']['goods_all_price']; ?>：
				<b class="ect-colory"><?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><?php echo $this->_var['lang']['gb_deposit']; ?><?php endif; ?><?php echo $this->_var['order']['formated_goods_amount']; ?></b>
			</p>
