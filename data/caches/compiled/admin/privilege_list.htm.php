...
<table cellspacing='1' cellpadding='3' id='list-table'>
  <tr>
    ...
    <th><?php echo $this->_var['lang']['proxy_user']; ?></th>
    <th><?php echo $this->_var['lang']['proxy_region']; ?></th>
...
?>
  <tr>
    ...
    <td align="center"><?php if ($this->_var['list']['proxy_user']): ?> <img src="images/yes.gif"> <?php else: ?> <img src="images/no.gif"> <?php endif; ?></td>
    <td align="center"><?php echo $this->_var['list']['proxy_region_name']; ?></td>
