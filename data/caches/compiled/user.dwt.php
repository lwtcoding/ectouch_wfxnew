...
<div class="con m-b7">
	...
	<section class="b-color-f my-nav-box m-top10">
		<?php if ($this->_var['rank_level'] == "代理"): ?>
		<a href="<?php echo url('index/index');?>">
			<div class="dis-box padding-all my-bottom">
				<h3 class="box-flex text-all-span my-u-title-size"><i class="iconfont icon-dianpuzhuye is-user-size t-first"></i>我要下单</h3>
	...
	<section class="m-top10 my-nav-box b-color-f">
		<a href="<?php echo url('user/account_detail');?>;">
			<div class="dis-box padding-all my-bottom">
				...
				<div class="box-flex t-goods1 text-right onelist-hidden jian-top"><?php if ($this->_var['list']['user_money'] != ''): ?> <?php echo $this->_var['list']['user_money']; ?><?php else: ?>0<?php endif; ?></div>
				<span class="t-jiantou"><i class="iconfont icon-jiantou tf-180 jian-top"></i></span>
			</div>
		</a>
		<?php if ($this->_var['rank_level'] == "代理"): ?>
		<ul class="user-money-list g-s-i-title-1 dis-box text-center">
			...
			<a href="<?php echo url('user/bonus');?>" class="box-flex" style="display: none;">
				<li>
					<h4 class="ellipsis-one">
					<?php if ($this->_var['list']['bonus'] != ''): ?> <?php echo $this->_var['list']['bonus']; ?><?php else: ?>0<?php endif; ?>
					</h4>
					<p class="t-remark3">红包</p>
				</li>
			</a>
			<div  class="box-flex" style="display: none;">
				<li>
	...
	<footer class="b-color-f m-top10">
		<div class="user-item-list">
			<a class="my-bottom user_items" href="<?php echo url('user/profile');?>">
			...
			<a class="my-bottom user_items" href="<?php echo url('user/service');?>">
				<div class="dis-box padding-all">
					<h3 class="box-flex text-all-span my-u-title-size">
			...
			<?php if ($this->_var['info']['is_proxy'] == 1): ?>
			<a class="my-bottom user_items" href="<?php echo url('sale/index');?>">
				<div class="dis-box padding-all">
					<h3 class="box-flex text-all-span my-u-title-size">
			...
			<?php else: ?>
				<?php if (! $this->_var['info']['is_vip']): ?>
				<a class="my-bottom user_items" href="<?php echo url('user/user_vip_apply');?>">
    				<div class="dis-box padding-all">
    					<h3 class="box-flex text-all-span my-u-title-size">
    						<i class="iconfont icon-dianpu"></i>
    						成为加盟商
		...
		<!--<div class="user-fu-box">
			<div class="box text-c b-color-f dis-box">
				...
				<?php if ($this->_var['rank_level'] == 1): ?>
				<!--<a href="<?php echo url('sale/index');?>" class="box-flex">
					<i class="iconfont icon-dianpu"></i>
			        <p class="f-03 col-6">微店管理</p>
			    </a>-->
			    <?php else: ?>
			    <!--<a href="<?php echo url('store/check_store');?>" class="box-flex">
					<i class="iconfont icon-dianpu"></i>
					<p class="f-03 col-6">申请加盟</p>
				</a>-->
			    <?php endif; ?>
