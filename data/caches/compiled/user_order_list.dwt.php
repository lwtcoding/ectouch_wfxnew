			...
			<li class="order_list">
				<a href="<?php echo url('user/order_detail', array('order_id'=>$this->_var['orders']['order_id']));?>">
					...
					<div class="flex-row order_info">
						<img src="<?php echo $this->_var['orders']['img']; ?>"/>
						<div class="order_info_text">
							<p><?php echo $this->_var['lang']['order_status']; ?>：<?php echo $this->_var['orders']['order_status']; ?></p>
						  	<p><?php echo $this->_var['lang']['order_total_fee']; ?>：<span class="ect-color"><?php echo $this->_var['orders']['total_fee']; ?></span></p>
						  	<p><?php echo $this->_var['lang']['order_addtime']; ?>：<?php echo $this->_var['orders']['order_time']; ?></p>
						</div>
					</div>
