<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:67:"/Users/lwt/PhpstormProjects/ectouch_wfxnew/themes/default/index.dwt";i:1;s:85:"/Users/lwt/PhpstormProjects/ectouch_wfxnew/themes/default/library/new_page_header.lbi";i:2;s:82:"/Users/lwt/PhpstormProjects/ectouch_wfxnew/themes/default/library/index_navbar.lbi";i:3;s:80:"/Users/lwt/PhpstormProjects/ectouch_wfxnew/themes/default/library/new_search.lbi";i:4;s:85:"/Users/lwt/PhpstormProjects/ectouch_wfxnew/themes/default/library/new_page_footer.lbi";}s:7:"expires";i:1534222165;s:8:"maketime";i:1534218565;}<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" >var tpl = '/themes/default';</script><div class="con m-b7 new-maxbox">
	...
	<div class="index-banner swiper-container box position-rel banner-first">
			...
			<ul class="dis-box">
				<li class="index-left-box"><a href="/index.php?m=default&c=category&a=top_all&u=24"><i class="iconfont icon-caidan color-whie"></i></a></li>
				...
				<li class="index-right-box"><a href="/index.php?m=default&c=user&a=msg_list&u=24"><i class="iconfont icon-xiaoxi1 color-whie n-xiaoxi-size"></i></a></li>
			</ul>
		</div>
...
<footer class="footer-nav dis-box">
	<a href="/index.php?m=default&c=index&a=index&u=24" class="box-flex nav-list">
		<i class="nav-box i-home"></i><span>总部</span>
	</a>
	<a href="/index.php?m=default&c=category&a=top_all&u=24" class="box-flex nav-list">
		<i class="nav-box i-cate"></i><span>分类</span>
	</a>
	<a href="/index.php?m=default&c=flow&a=cart&u=24" class="box-flex position-rel nav-list">
		<i class="nav-box i-flow"></i><span>购物车</span>
	</a>
	<!--<a href="/index.php?m=default&c=store&a=check_store&u=24" class="box-flex nav-list ">
		<i class="nav-box i-shop"></i><span>店铺</span>
	</a>-->
	<a href="/index.php?m=default&c=user&a=index&u=24" class="box-flex nav-list">
		<i class="nav-box i-user"></i><span>我的</span>
	</a>
</footer>				
<div class="search-div ts-3">
	<section class="search">
		<form action="/index.php?m=default&c=category&a=index&u=24" method="post">
...
<script type="text/javascript">
	get_asynclist("/index.php?m=default&c=index&a=ajax_goods&type=onsale&u=24", '__TPL__/images/loader.gif');
</script>
<script type="text/javascript ">
	$(function($) {		
		$(".footer-nav .nav-list").eq(0).addClass("active");
